/****************************************************************************
** Meta object code from reading C++ file 'suggestcompletion.h'
**
...
#include "../../success/Student_association_management_system/suggestcompletion.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'suggestcompletion.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(3, 34, 14), // "preventSuggest"
QT_MOC_LITERAL(4, 49, 11) // "autoSuggest"

    },
    "SuggestCompletion\0doneCompletion\0\0"
    "preventSuggest\0autoSuggest"
};
...
const QMetaObject SuggestCompletion::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_SuggestCompletion.data,
      qt_meta_data_SuggestCompletion,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *SuggestCompletion::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SuggestCompletion.stringdata0))
        return static_cast<void*>(const_cast< SuggestCompletion*>(this));
