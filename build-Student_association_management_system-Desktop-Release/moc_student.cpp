...
#include "../../success/Student_association_management_system/student.h"
...
QT_MOC_LITERAL(3, 21, 8), // "Student&"
QT_MOC_LITERAL(4, 30, 13) // "StudentAccept"

    },
    "Student\0ReceiveData\0\0Student&\0"
    "StudentAccept"
};
...
void Student::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->ReceiveData((*reinterpret_cast< Student(*)>(_a[1]))); break;
        case 1: _t->StudentAccept(); break;
        default: ;
        }
        ...
        {
            typedef void (Student::*_t)(Student & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Student::ReceiveData)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Student::ReceiveData(Student & _t1)
{
